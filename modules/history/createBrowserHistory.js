...
export const FREYA_GLOBAL_MANGER = []
export const isLastPage = () => FREYA_GLOBAL_MANGER.length <= 1
...
function createBrowserHistory(props = {}) {
    ...
    function setState(nextState) {
        if (nextState && nextState.action == 'PUSH') {
            ...
            if (goNum) {
                ...
                //ios9 init pop
                if (FREYA_GLOBAL_MANGER.length !== 1) {
                    FREYA_GLOBAL_MANGER.pop()
                }
    ...
    FREYA_GLOBAL_MANGER.push(initialLocation)
